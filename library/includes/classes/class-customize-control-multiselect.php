 ...
 * @version  2.1.1
 */
class Boo_Valley_Customize_Control_Multiselect extends WP_Customize_Control {
		...
		// Processing
			...
			// Scripts
				...
				if ( 'multicheckbox' === $this->type ) {
					...
					wp_enqueue_script(
							'boo_valley-customize-control-multicheckbox',
							get_theme_file_uri( BOO_VALLEY_LIBRARY_DIR . 'js/customize-control-multicheckbox.js' ),
	...
	public function render_content_select() {
		...
		// Output
			...
			<label>
				...
				<em><?php esc_html_e( 'Press CTRL key for multiple selection.', 'boo-valley' ); ?></em>
			</label>
...
} // /Boo_Valley_Customize_Control_Multiselect
