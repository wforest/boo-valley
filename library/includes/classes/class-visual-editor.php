 ...
 * 30) Body class
 */
final class Boo_Valley_Library_Visual_Editor {
	 ...
	 */
		...
		public static function add_buttons_row1( $buttons ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_boo_valley_library_editor_add_buttons_row1_pre', false, $buttons );
		...
		public static function add_buttons_row2( $buttons ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_boo_valley_library_editor_add_buttons_row2_pre', false, $buttons );
	 ...
	 */
		...
		public static function custom_mce_format( $init ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_boo_valley_library_editor_custom_mce_format_pre', false, $init );
			...
			// Processing
				...
				// Add custom formats
					...
					$style_formats = (array) apply_filters( 'wmhook_boo_valley_library_editor_custom_mce_format', array(

							// Group: Text styles

								100 . 'text_styles' => array(
									'title' => esc_html__( 'Text styles', 'boo-valley' ),
									'items' => array(

										100 . 'text_styles' . 100 => array(
											'title'    => esc_html__( 'Dropcap text', 'boo-valley' ),
											'selector' => 'p',
											'classes'  => 'dropcap-text',
										),

										100 . 'text_styles' . 110 => array(
											'title'    => esc_html__( 'Uppercase heading or paragraph', 'boo-valley' ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p, address',
											'classes'  => 'uppercase',
										),

										100 . 'text_styles' . 120 => array(
											'title'  => esc_html__( 'Highlighted (marked) text', 'boo-valley' ),
											'inline' => 'mark',
											'icon'   => ( is_admin() ) ? ( 'backcolor' ) : ( '' ),
										),

										100 . 'text_styles' . 130 => array(
											'title'  => esc_html__( 'Small text', 'boo-valley' ),
											'inline' => 'small',
										),

										100 . 'text_styles' . 140 => array(
											'title'  => esc_html__( 'Superscript', 'boo-valley' ),
											'icon'   => ( is_admin() ) ? ( 'superscript' ) : ( '' ),
											'format' => 'superscript',
										),

										100 . 'text_styles' . 150 => array(
											'title'  => esc_html__( 'Subscript', 'boo-valley' ),
											'icon'   => ( is_admin() ) ? ( 'subscript' ) : ( '' ),
											'format' => 'subscript',
										),

										100 . 'text_styles' . 160 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'boo-valley' ), 1 ),
											'selector' => 'h2, h3, h4, h5, h6, p, address',
											'classes'  => 'h1',
										),

										100 . 'text_styles' . 170 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'boo-valley' ), 2 ),
											'selector' => 'h1, h3, h4, h5, h6, p, address',
											'classes'  => 'h2',
										),

										100 . 'text_styles' . 180 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'boo-valley' ), 3 ),
							...
							// Group: Text size
								...
								200 . 'text_sizes' => array(
									'title' => esc_html__( 'Text sizes', 'boo-valley' ),
									'items' => array(

										200 . 'text_sizes' . 100 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'boo-valley' ), 1 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p, address',
											'classes'  => 'display-1',
										),

										200 . 'text_sizes' . 110 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'boo-valley' ), 2 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p, address',
											'classes'  => 'display-2',
										),

										200 . 'text_sizes' . 120 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'boo-valley' ), 3 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p, address',
											'classes'  => 'display-3',
										),

										200 . 'text_sizes' . 130 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'boo-valley' ), 4 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p, address',
											'classes'  => 'display-4',
										),
							...
							// Group: Quotes
								...
								300 . 'quotes' => array(
									'title' => esc_html_x( 'Quotes', 'Visual editor blockquote formats group title.', 'boo-valley' ),
									'items' => array(

										300 . 'quotes' . 100 => array(
											'title' => esc_html__( 'Blockquote', 'boo-valley' ),
											'block' => 'blockquote',
											'icon'  => ( is_admin() ) ? ( 'blockquote' ) : ( '' ),
										),

										300 . 'quotes' . 110 => array(
											'title'   => esc_html__( 'Pullquote - align left', 'boo-valley' ),
											'block'   => 'blockquote',
										...
										300 . 'quotes' . 120 => array(
											'title'   => esc_html__( 'Pullquote - align right', 'boo-valley' ),
											'block'   => 'blockquote',
										...
										300 . 'quotes' . 130 => array(
											'title'  => esc_html_x( 'Cite', 'Visual editor format label for HTML CITE tag used to set the blockquote source.', 'boo-valley' ),
											'inline' => 'cite',
										),
		...
		public static function scripts_post_edit( $hook_suffix = '' ) {
			...
			// Processing
				...
				// Scripts
					...
					wp_enqueue_script(
							'boo_valley-post-edit',
							get_theme_file_uri( BOO_VALLEY_LIBRARY_DIR . 'js/post.js' ),
							array( 'jquery' ),
...
} // /Boo_Valley_Library_Visual_Editor

add_action( 'init', 'Boo_Valley_Library_Visual_Editor::init' );
