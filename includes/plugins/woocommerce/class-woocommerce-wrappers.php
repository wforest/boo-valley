 ...
 * 100) Others
 */
class Boo_Valley_WooCommerce_Wrappers {
	 ...
	 */
		...
		public static function template_part_wrapper_open( $template_name ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_boo_valley_woocommerce_wrappers_template_part_wrapper_open_pre', false, $template_name );
		...
		public static function template_part_wrapper_close( $template_name ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_boo_valley_woocommerce_wrappers_template_part_wrapper_close_pre', false, $template_name );
	 ...
	 */
		...
		public static function product_info_open() {
			...
			// Helper variables
				...
				$class = ( get_theme_mod( 'woocommerce_product_background_shade', true ) ) ? ( ' has-shaded-background' ) : ( '' );


			// Output

				echo '<section class="summary-container' . esc_attr( $class ) . '"><div class="summary-container-inner">';
...
} // /Boo_Valley_WooCommerce_Wrappers

add_action( 'after_setup_theme', 'Boo_Valley_WooCommerce_Wrappers::init' );
