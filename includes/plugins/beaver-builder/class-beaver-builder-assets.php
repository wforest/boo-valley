 ...
 * 30) Custom styles
 */
class Boo_Valley_Beaver_Builder_Assets {
	 ...
	 */
			...
			// Processing
				...
				if ( class_exists( 'FLBuilderModel' ) && FLBuilderModel::is_builder_active() ) {
					...
					// Scripts
						...
						if ( class_exists( 'Boo_Valley_Beaver_Builder_Form' ) ) {

							$bb_settings = Boo_Valley_Beaver_Builder_Form::register_settings_form( array(), 'col' );
		...
		public static function editor_style() {
			...
			// Helper variables
				...
				$theme_editor_styles = array_filter( (array) apply_filters( 'wmhook_boo_valley_setup_editor_stylesheets', array() ) );
...
} // /Boo_Valley_Beaver_Builder_Assets

add_action( 'after_setup_theme', 'Boo_Valley_Beaver_Builder_Assets::init' );
