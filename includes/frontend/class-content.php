	 ...
	 */
		...
		public static function headings_level_up( $html ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_boo_valley_content_headings_level_up_pre', false, $html );
...
add_action( 'after_setup_theme', 'Boo_Valley_Content::init' );
