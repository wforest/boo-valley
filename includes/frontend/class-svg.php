				...
				// Hooks
					...
					// Actions
						...
						// Social menu SVG symbols cache flush
							...
							add_action( 'wmhook_boo_valley_library_theme_upgrade', __CLASS__ . '::social_icons_symbols_cache_flush' );
	 ...
	 */
		...
		public static function get_social_icons_symbols() {
			...
			// Helper variables
				...
				$output = ( $is_customize_preview ) ? ( '' ) : ( (string) get_transient( 'boo_valley_social_icons_symbols' ) );
			...
			// Processing
				...
				// Cache the markup
					...
					set_transient( 'boo_valley_social_icons_symbols', $output );
		...
		public static function social_icons_symbols_cache_flush() {
			...
			// Processing
				...
				delete_transient( 'boo_valley_social_icons_symbols' );
	 ...
	 */
		...
		public static function get( $args = array() ) {
			...
			// Helper variables
				...
				$args = (array) apply_filters( 'wmhook_boo_valley_svg_get_args', $args );
				 ...
				 *
				 * Example 1 with title: <?php echo Boo_Valley_SVG::get( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ) ) ); ?>
				 *
				 * Example 2 with title and description: <?php echo Boo_Valley_SVG::get( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ), 'desc' => __( 'This is the description', 'textdomain' ) ) ); ?>
				 *
			...
			// Processing
				...
				$output = (array) apply_filters( 'wmhook_boo_valley_svg_get_output', $output, $args );
...
add_action( 'after_setup_theme', 'Boo_Valley_SVG::init' );
